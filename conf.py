# -*- coding: utf-8 -*-
#
# psych-214 documentation build configuration file, created by
...
exclude_patterns = ['_build', 'on-dummies', 'tools', 'tools/examples']
...
html_title = u"Functional MRI methods"
...
htmlhelp_basename = 'fmri-methods-doc'
...
latex_documents = [
  (master_doc, 'fmri-methods.tex', html_title,
...
man_pages = [
    (master_doc, 'fmri-methods', html_title,
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'fmri-methods', html_title,
   author, 'fmri-methods', 'One line description of project.',
   'Miscellaneous'),
]
