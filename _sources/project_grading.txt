...
|                | analysis                            | Plots convey information but lack   | Plots convey information             |
...
|                | illegible                           | Verbal and visual                   | and crisp                            |
|                | Verbal and visual                   | presentation related                | Verbal and visual                    |
|                | presentation unrelated              |                                     | presentation clearly related         |
+----------------+-------------------------------------+-------------------------------------+--------------------------------------+
...
+----------------+-------------------------------------+-------------------------------------+--------------------------------------+
| Reproduciblity | Code didn't run, or README recipe   | README recipe fetches data,         | README recipes additionally generate |
|                | does not specify steps to reproduce | validates fetched data,             | all EDA work and supplementary       |
|                | results and figures in project      | generates all results and           | analysis.  Recipes short and simple  |
|                | report                              | figures in report                   | with nearly all steps automated      |
|                |                                     |                                     | with scripts and / or Makefiles      |
+----------------+-------------------------------------+-------------------------------------+--------------------------------------+
