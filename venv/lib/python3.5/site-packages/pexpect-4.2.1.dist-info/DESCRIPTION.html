...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>&lt;no title&gt; &mdash; Functional MRI methods</title>
...
<p>Pexpect is a pure Python module for spawning child applications; controlling
them; and responding to expected patterns in their output. Pexpect works like
Don Libes&#8217; Expect. Pexpect allows your script to spawn a child application and
control it as if a human were typing commands.</p>
<p>Pexpect can be used for automating interactive applications such as ssh, ftp,
passwd, telnet, etc. It can be used to a automate setup scripts for duplicating
software package installations on different servers. It can be used for
automated software testing. Pexpect is in the spirit of Don Libes&#8217; Expect, but
Pexpect is pure Python.</p>
<p>The main features of Pexpect require the pty module in the Python standard
...
<script type="text/javascript">$('#searchbox').show(0);</script>
    ...
    <div class="footer">
      ...
      |
      <a href="../../../../../_sources/venv/lib/python3.5/site-packages/pexpect-4.2.1.dist-info/DESCRIPTION.txt"
